...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "BrainboxWorld — Premium Digital Agency" },
      { property: "og:description", content: "Websites, SEO and marketing that grow revenue. Trusted creative digital agency." },
